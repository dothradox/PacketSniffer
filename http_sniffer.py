...
def sniff_packets(iface=None):
    ...
    # We passed the process_packet() function to sniff()
    # function as the callback that is called whenever a packet is sniffed, it takes packet as an argument.
...
def process_packet(packet):
    ...
    if packet.haslayer(HTTPRequest):
        ...
        if show_raw and packet.haslayer(Raw) and method == "POST":
            # if show_raw flag is enabled, has raw data, and the requested method is "POST" then show raw
            print(
